    ...
    <header>
        <div class="nav-bar-container">
            ...
            <div class="openMenu"><i class="fa fa-bars"></i></div>
                <img class="nav-option-logo-img" src="<?php echo get_stylesheet_directory_uri(); ?>/icons/compass.svg"
                    alt="logo">
            ...
            <div class="nav-hero">
                <img class="nav-hero-img" src="<?php echo get_stylesheet_directory_uri(); ?>/img/hero.jpg"
                    alt="scotland">
                <div class="nav-hero-text">"Gdzie kończy się droga, tam zaczyna się przygoda"</div>
            </div>
            <form class="nav-form">
